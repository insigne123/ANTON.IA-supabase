...
test('external lead tools use FullEnrich leases, including legacy provider inputs', () => {
  const env = { SUPLIA_FULLENRICH_CONCURRENCY_PER_ORG: '1', SUPLIA_TOOL_LEASE_TTL_SECONDS: '90' };
