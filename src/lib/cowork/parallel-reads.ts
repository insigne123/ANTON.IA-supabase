...
const FIXED_ACTIONS = ['metrics.overview', 'metrics.rates', 'metrics.diagnose', 'metrics.channels', 'metrics.incidents', 'app.context', 'campaigns.list', 'files.list', 'saved_searches.list', 'profile.get',
