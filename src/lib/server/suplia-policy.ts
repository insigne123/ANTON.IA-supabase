...
const POLICIES: Record<string, SupliaPolicy> = {
  ...
  'email.bulk_send': {
    ...
    requiresApproval: true,
    approvalKind: 'strong',
    approvalReason: 'Preparar varios borradores crea trabajo de contacto persistente y requiere revisar volumen, destinatarios y contenido antes de la revisión individual.',
  },
  'replies.sync': {
    riskLevel: 'low',
    requiresApproval: false,
