...
function UnsubscribeContent() {
    ...
    const hasLegacyParams = !!(email && u && sig);
    const hasValidShape = !!token || hasLegacyParams;
        ...
        return (
            <Card className="w-full max-w-md border-red-200">
                <CardHeader>
                    ...
                    <CardDescription>
                        Este enlace no contiene la información necesaria para procesar la baja.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <p className="text-sm text-muted-foreground">
                        Si aún deseas dejar de recibir mensajes, responde al remitente o escríbenos al correo de privacidad indicado en la política del servicio.
                    </p>
                </CardContent>
            </Card>
        );
        ...
        return (
            <Card className="w-full max-w-md border-green-200">
                <CardHeader>
                    ...
                    <CardDescription>
                        {resolvedEmail ? (
                            <>La dirección <strong>{resolvedEmail}</strong> ha sido eliminada correctamente de nuestra lista de envíos.</>
                        ) : (
                            'La solicitud de baja fue procesada correctamente.'
                        )}
                    </CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <CardHeader>
                    ...
                    <CardDescription>
                        {email ? (
                            ...
                            '¿Estás seguro de que deseas dejar de recibir más correos desde esta cuenta?'
                        )}
                    </CardDescription>
                </CardHeader>
            <CardContent>
