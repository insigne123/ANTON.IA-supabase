...
export async function POST(
    ...
    try {
        ...
        const payload = {
            ...
            idealCustomerProfile: missionParams.idealCustomerProfile || '',
            valueProposition: missionParams.valueProposition || '',
            applyIcpFilter: missionParams.applyIcpFilter !== false,
