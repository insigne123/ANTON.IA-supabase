...
// Kept below for migration diagnostics only. Production contact actions must
// move through an approved messaging draft and the canonical provider route.
...
export async function POST() {
    return NextResponse.json({
        ...
        message: 'El envío automático heredado fue retirado. Revisa y aprueba un borrador antes de enviar.',
    }, {
        status: 410,
        headers: {
