...
import { addEnrichedOppLeadsDedup } from '@/lib/saved-enriched-opps-storage';
...
export default function SavedOpportunitiesPage() {
    ...
    useEffect(() => {
        setOpps(savedOpportunitiesStorage.get());
    }, []);
    ...
    const handleExportCsv = () => {
        ...
        const headers = [
          ...
          { key: 'companyUrl', label: 'URL Empresa' },
        ...
        const rows = opps.map(o => ({
          ...
          location: o.location || '',
          publishedAt: (o as any).publishedAt || '',
          postedTime: (o as any).postedTime || '',
          jobUrl: o.jobUrl || '',
          companyUrl: (o as any).companyUrl || o.companyLinkedinUrl || '',
          applyUrl: (o as any).applyUrl || '',
    ...
    const enrichSelectedLeads = async () => {
        ...
        addEnrichedOppLeadsDedup(enrichedNow);
