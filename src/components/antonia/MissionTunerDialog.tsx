                        ...
                        <div className="rounded-3xl border border-slate-200/80 bg-slate-50/80 p-4">
                          <div className="flex items-start justify-between gap-4">
                            <div className="space-y-1">
                              ...
                              <p className="text-xs leading-5 text-slate-500">Si lo apagas, la misión guardará los leads del search sin descartarlos por el segundo filtro de calificación.</p>
                            </div>
