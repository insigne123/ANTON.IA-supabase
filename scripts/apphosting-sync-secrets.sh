...
firebase apphosting:secrets:grantaccess \
  FULLENRICH_API_KEY,SERPER_API_KEY,AZURE_AD_CLIENT_SECRET,GOOGLE_CLIENT_SECRET,SUPABASE_SERVICE_ROLE_KEY,LEAD_RESEARCH_WORKER_SECRET,FIREBASE_SCHEDULER_SECRET,ANTONIA_TICK_SECRET,TRACKING_WEBHOOK_SECRET \
  -P "$TARGET_PROJECT" \
  -b "$BACKEND" \
  -l "$LOCATION"
