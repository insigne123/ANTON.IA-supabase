...
const mocks={
  ...
  './operations':'export const coworkOperationHash=()=>"hash";export const createCoworkOperationGateway=()=>({invoke:async()=>{throw new Error("unused gateway")}});export const createCoworkOperationDependencies=()=>{throw new Error("specialists disabled")};',
