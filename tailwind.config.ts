  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        code: ['monospace'],
        'cw-sans': ['var(--cw-sans)'],
        'cw-heading': ['var(--cw-heading)'],
        'cw-mono': ['var(--cw-mono)'],
      },
      colors: {
        // Cowork workspace palette (src/styles/cowork.css), scoped under `.cw-shell`.
        cw: {
          bg: 'var(--cw-bg)',
          rail: 'var(--cw-rail)',
          panel: 'var(--cw-panel)',
          ...
          'accent-hover': 'var(--cw-accent-hover)',
          'accent-soft': 'var(--cw-accent-soft)',
          'on-accent': 'var(--cw-on-accent)',
